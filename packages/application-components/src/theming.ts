...
export const themesOverrides = {
  default: {
    ...
    marginForCustomViewsSelectorAsTabularInCustomView: '0',
    ...
    paddingForDetailPageHeaderInCustokmView: `0 0 ${uiKitDesignTokens.spacing40} 0`,
    ...
    paddingForMainPageHeaderInCustomView: '0',
    paddingForModalPageHeader: `${uiKitDesignTokens.spacing40} 0 ${uiKitDesignTokens.spacing40}`,
    paddingForModalPageHeaderInCustomView: `0 0 ${uiKitDesignTokens.spacing40} 0`,
    ...
    paddingForTabularPageHeaderInCustomView: '0',
