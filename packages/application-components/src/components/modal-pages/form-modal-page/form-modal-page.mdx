---
id: components-form-modal-page
title: Form Modal Page - Components
permalink: /components/form-modal-page
---

# FormModalPage

import { FormModalPage } from '@commercetools-frontend/application-components';
import { Spacings, Text, TextField } from '@commercetools-frontend/ui-kit';
...
>
  <div id="form-modal-page-1" style={{ flex: 1 }} />
    <FormModalPage
      title="Lorem ipsum"
      isOpen={true}
      onClose={() => {}}
      ...
      parentSelector={() => document.querySelector('#form-modal-page-1')}
    >
