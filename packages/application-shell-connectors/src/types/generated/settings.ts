...
export type TFetchProjectExtensionImageRegexQuery = { __typename?: 'Query', projectExtension: Maybe<{ __typename?: 'ProjectExtension', id: string, imageRegex: Maybe<{ __typename?: 'ImageRegex', thumb: Maybe<{ __typename?: 'ImageRegexOptions', flag: string, search: string, replace: string }>, small: Maybe<{ __typename?: 'ImageRegexOptions', flag: string, search: string, replace: string }> }> }> };
...
export type TFetchProjectExtensionsNavbarQuery = { __typename?: 'Query', projectExtension: Maybe<{ __typename?: 'ProjectExtension', id: string, applications: Maybe<Array<{ __typename?: 'ApplicationExtension', id: string, navbarMenu: Maybe<{ __typename?: 'NavbarMenu', id: string, key: string, uriPath: string, icon: string, featureToggle: Maybe<string>, permissions: Array<TOAuthScope>, labelAllLocales: Maybe<Array<{ __typename?: 'LocalizedField', locale: string, value: string }>>, submenu: Maybe<Array<{ __typename?: 'NavbarSubmenu', id: string, key: string, uriPath: string, permissions: Array<TOAuthScope>, featureToggle: Maybe<string>, labelAllLocales: Maybe<Array<{ __typename?: 'LocalizedField', locale: string, value: string }>> }>> }> }>>, installedApplications: Maybe<Array<{ __typename?: 'RestrictedCustomApplicationInstallationForProject', application: { __typename?: 'RestrictedCustomApplicationForProject', id: string, entryPointUriPath: string, menuLinks: Maybe<{ __typename?: 'CustomApplicationMenuLink', id: string, icon: string, permissions: Array<string>, defaultLabel: string, labelAllLocales: Maybe<Array<{ __typename?: 'LocalizedField', locale: string, value: string }>>, submenuLinks: Maybe<Array<{ __typename?: 'CustomApplicationSubmenuLink', id: string, uriPath: string, permissions: Array<string>, defaultLabel: string, labelAllLocales: Maybe<Array<{ __typename?: 'LocalizedField', locale: string, value: string }>> }>> }> } }>> }> };
