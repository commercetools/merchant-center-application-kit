...
const itemsCategories = {
  ...
  submenu: [
    ...
    },
    {
      ...
      nameOfMenuVisibility: 'hideAddCategory',
    },
  ],
};
  ...
  submenu: [
    {
      ...
      uriPath: 'customers',
      nameOfMenuVisibility: 'hideCustomersList',
    },
    {
      key: 'AddCustomer',
      ...
      nameOfMenuVisibility: 'hideAddCustomer',
    },
    {
      key: 'CustomerGroups',
      ...
      nameOfMenuVisibility: 'hideCustomerGroupsList',
    },
    {
      ...
      permissions: [permissions.ManageCustomers],
      nameOfMenuVisibility: 'hideAddCustomerGroup',
    },
  ],
};
  ...
  submenu: [
    {
      ...
      nameOfMenuVisibility: 'hideProductDiscountsList',
    },
    {
      key: 'CartDiscounts',
      ...
      nameOfMenuVisibility: 'hideCartDiscountsList',
    },
    {
      key: 'DiscountCodes',
      ...
      permissions: [permissions.ViewOrders],
      nameOfMenuVisibility: 'hideDiscountCodesList',
    },
    {
      key: 'AddDiscount',
      ...
      nameOfMenuVisibility: 'hideAddDiscounts',
    },
  ],
};
  ...
  submenu: [
    {
      ...
      uriPath: 'orders',
      nameOfMenuVisibility: 'hideOrdersList',
    },
    {
      key: 'AddOrders',
      ...
      nameOfMenuVisibility: 'hideAddOrder',
    },
  ],
};
  ...
  submenu: [
    {
      ...
      uriPath: 'products',
      nameOfMenuVisibility: 'hideProductsList',
    },
    {
      ...
      permissions: [permissions.ManageProducts],
      nameOfMenuVisibility: 'hideModifiedProducts',
    },
    {
      key: 'PimSearchList',
      ...
      permissions: [permissions.ViewProducts, permissions.ManageProducts],
      nameOfMenuVisibility: 'hidePimSearchList',
    },
    {
      key: 'AddProduct',
      ...
      permissions: [permissions.ManageProducts],
      nameOfMenuVisibility: 'hideAddProduct',
    },
    {
      key: 'DirectAccess',
      labelKey: 'NavBar.Products.directAccess',
      uriPath: 'products/direct-access',
      nameOfMenuVisibility: 'hideDirectAccess',
    },
  ],
};
  ...
  submenu: [
    {
      ...
      nameOfMenuVisibility: 'hideProjectSettings',
    },
    {
      key: 'Product types',
      ...
      nameOfMenuVisibility: 'hideProductTypes',
    },
    {
      ...
      permissions: [permissions.ManageProject],
      nameOfMenuVisibility: 'hideDeveloperSettings',
    },
    {
      ...
      permissions: [permissions.ManageProject],
      nameOfMenuVisibility: 'hideCustomApplications',
    },
  ],
};
