...
| `options.sdkMocks`    | `Array`       | Redux                                                                                                                                                                                              | Allows to mock requests made with `@commercetools-frontend/sdk` (Redux). A mock contains an object with `{ action, response }`, where `action` represents the Redux action from the `@commercetools-frontend/sdk` package and `response` represents the network JSON response.                                                            |
