...
| `onMenuItemClick`                | `func`             |           ✅            | -       | A callback function to be called on Navbar menu item click. The function is called with a single parameter, object representing menu item.                                                                                                                                                                                                                                       |
