# ⚠️ This package is copied from [the (unreleased) CRA PR for Webpack 4](https://github.com/facebook/create-react-app/pull/4077). When the package is properly released, we can remove this folder again. ⚠️
