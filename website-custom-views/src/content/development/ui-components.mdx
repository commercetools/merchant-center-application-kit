...
In the previous section we learned how to use data fetching by using the built-in features of Custom Views.
The next natural step when developing a Custom View is to implement the actual User Interface.
...
The `<Spacings>` components let you position elements in your Custom View.
...
<br />
Chances are that in your Custom View you would need to do exactly that.
