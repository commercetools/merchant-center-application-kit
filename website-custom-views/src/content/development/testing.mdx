...
* `projectLllAppliedPermissions`: a list of applied resource permissions that the user should have for the given Project. A resource permission is an object with the following shape:
...
const renderView = (options = {}) => {
  renderCustomViews(<ApplicationRoutes />, {
