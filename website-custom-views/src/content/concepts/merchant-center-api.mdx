...
To make it easier to reference the Merchant Center API URL, for example in the [Custom View config](/api-reference/application-config#cloudIdentifier), each cloud Region maps to an identifier.
