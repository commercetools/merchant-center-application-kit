...
An action creator to dispatch a (page) error notification for [API errors](https://docs-beta-custom-views.commercetools.vercel.app/api/errors) of the commercetools HTTP API.
