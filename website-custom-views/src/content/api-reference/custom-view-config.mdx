...
Since Custom Views are rendered in the context of built-in Merchant Center applications, you need to set in which specific views the Custom View should be rendered.
