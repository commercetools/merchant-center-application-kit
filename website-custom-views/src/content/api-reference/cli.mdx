...
This command compiles the `index.html.template` file into an `index.html` file according to the [Custom View config](/api-reference/custom-view-config). The production assets are then copied to the `public` folder and are ready to be deployed.
