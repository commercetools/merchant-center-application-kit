...
1. [Configure the Custom View in the Merchant Center](https://docs.commercetools.com/merchant-center/managing-custom-views#configuring-custom-views)
...
2. [Assign the Custom View ID](https://docs.commercetools.com/merchant-center/managing-custom-views#assigning-the-custom-view-id)
3. [Install the Custom View](https://docs.commercetools.com/merchant-center/managing-custom-views#installing-a-custom-view)
...
After completing these steps, you will have an `customViewId` and a `teamId`. You must provide these values for [`env.production.customViewId`](/api-reference/custom-view-config#envproductioncustomviewid) and [`env.development.teamId`](/api-reference/application-config#envdevelopmentteamid), respectively, in the Custom View configuration file.
