...
This deployment example refers to [Google Cloud Static Web Apps](https://cloud.google.com/storage/docs/hosting-static-website-http).
...
- A [valid domain](https://cloud.google.com/storage/docs/hosting-static-website-http#before-you-begin) that you own or manage.
...
To host the production bundles of your Custom View you need to create a [Cloud Storage bucket](https://cloud.google.com/storage/docs/hosting-static-website-http#create-bucket) in Google Cloud and [configure](https://cloud.google.com/storage/docs/hosting-static-website-http#sharing) the bucket.
...
Another way to verify your domain is by using a [load balancer](https://cloud.google.com/storage/docs/hosting-static-website#lb-ssl). You have the chance to upload an SSL certificate to your load balancer. If you are using Google Domain Name Service, in your domain [configuration](https://cloud.google.com/storage/docs/hosting-static-website-http#cname), add a new record that points your domain to the IP address of the load balancer you created.
