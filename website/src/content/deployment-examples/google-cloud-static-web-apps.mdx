...
<Info>
 ...
 Your domain name should be registered with a valid [secure certificates](https://support.google.com/domains/answer/7630973?hl=en&visit_id=637951191082633113-3999318342&rd=1) to avoid an internal server error from the Merchant enter.
