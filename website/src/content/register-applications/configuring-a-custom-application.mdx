...
- **Application URL**: The URL that hosts your application (for example `https://my-custom-app.com`). This should be the same as the `frontendHost` in your project's `env.json` file.
