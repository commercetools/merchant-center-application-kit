...
This command performs the user login to the Merchant Center. It automatically detects whether the application is running on localhost or on production and chooses the appropriate login mechanism.<br/>
...
Make sure that the following environment variables are available in case the related options are not explicitly provided: `PROJECT_KEY`, `LOGIN_USER`, `LOGIN_PASSWORD`.
