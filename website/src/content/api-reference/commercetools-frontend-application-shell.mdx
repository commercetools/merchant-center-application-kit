...
| ------------------------------------ | --------------------------------------- | -------------------------------------------------------------- |
| /some-project-key/products/`<id>`             | Products - some-project-key - Merchant Center  |             <product name> - Products - some-project-key - Merchant Center|
| /some-project-key/products/`<id>`/variants    | Products - some-project-key - Merchant Center |     <product name> - Products - some-project-key - Merchant Center |
| /some-project-key/products/`<id>`/variants/`<id>`  | 	Products - some-project-key - Merchant Center |  <product name> - Products - some-project-key - Merchant Center |
| /some-project-key/products/`<id>`/variants/`<id>`/prices  | 	Products - some-project-key - Merchant Center |  <product name> - Products - some-project-key - Merchant Center |
