...
| ------------------------------------ | --------------------------------------- | -------------------------------------------------------------- |
| /almond-40/products/`<id>`             | Products - almond-40 - Merchant Center  |             <product name> - Products - almond-40 - Merchant Center|
| /almond-40/products/`<id>`/variants    | Products - almond-40 - Merchant Center |     <product name> - Products - almond-40 - Merchant Center |
| /almond-40/products/`<id>`/variants/`<id>`  | 	Products - almond-40 - Merchant Center |  <product name> - Products - almond-40 - Merchant Center |
| /almond-40/products/`<id>`/variants/`<id>`/prices  | 	Products - almond-40 - Merchant Center |  <product name> - Products - almond-40 - Merchant Center |
