...
The application shell now has an instance of the `<ApplicationPageTitle>` component. Page titles in the browser tabs will now automatically get more readable titles.
