...
Returns a URL of the [Merchant Center API](/concepts/merchant-center-api) for the given URI path. This is useful to configure the request URL without having to get URL of the Merchant Center API.
