...
<MultiCodeExample title="entry-point">
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/app-shell-usage.js" />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/app-shell-usage.tsx" />
</MultiCodeExample>
...
| `environment`                  | `object`           |           ✅            | -       | The application runtime environment, which is exposed in `window.app`. See [Runtime configuration](/api-reference/commercetools-frontend-application-shell/application-config#runtime-application-environment).                                                                                                                                                                                                                                                                                                                                                       |
...
<MultiCodeExample title="entry-point">
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/setup-global-error-listener.js" highlightLines={[8]} />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/setup-global-error-listener.tsx" highlightLines={[8]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/create-apollo-client.js" />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/create-apollo-client.tsx" />
</MultiCodeExample>
...
<MultiCodeExample title="entry-point">
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/use-apollo-client-in-app.js" highlightLines={[6,7,10,11,16]} />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/use-apollo-client-in-app.tsx" highlightLines={[6,7,10,11,16]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/use-apollo-client-in-tests.ts" />
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/use-apollo-client-in-tests.js" />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/create-apollo-context-for-proxy-forward-to.js" highlightLines={[2,14,16,18,19,20]} />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/create-apollo-context-for-proxy-forward-to.ts" highlightLines={[2,14,16,18,19,20]} />
</MultiCodeExample>
...
For more information see [configuring the audience policy](/concepts/integrate-with-your-own-api#configuring-the-audience-policy).
...
<MultiCodeExample title="entry-point">
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/tests-render-app.js" highlightLines={[8,9,10,12]} />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/tests-render-app.tsx" highlightLines={[8,9,10,12]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample language="js" path="api-reference/commercetools-frontend-application-shell/tests-render-app-with-redux.js" highlightLines={[8,9,10,12]} />
  <CodeExample language="ts" path="api-reference/commercetools-frontend-application-shell/tests-render-app-with-redux.tsx" highlightLines={[8,9,10,12]} />
</MultiCodeExample>
