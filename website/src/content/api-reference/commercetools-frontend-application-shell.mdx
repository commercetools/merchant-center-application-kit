...
* `includeUserPermissions` (optional): Whether to include an additional token claim in forwarded request containing the logged-in user permissions. See [configuring custom claims](/concepts/integrate-with-your-own-api#configuring-custom-claims)
