...
* `includeUserPermissions` (optional): Whether to include an additional JWT claim in proxied request containing the logged-in user permissions. See [configuring custom claims](/concepts/integrate-with-your-own-api#configuring-custom-claims)
