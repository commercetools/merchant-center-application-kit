...
You can provide a list of folders path to be included when webpack scans your project for source files by making use of the `sourceFolders` property. The Provided list of folders overrides the default source folders in the config.
