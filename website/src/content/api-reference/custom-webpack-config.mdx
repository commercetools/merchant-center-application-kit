...
However, it could be that your application requires some extra functionality like loading a particular file type, using a specific webpack plugin or simply include other source files in your repository.
In order to extend the functionalities of webpack, you can define specific files in the root of your Custom Application project.
...
You can list folders where Webpack should look for source files.
