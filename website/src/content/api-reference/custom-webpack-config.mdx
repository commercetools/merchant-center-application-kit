...
You can pass a list of folders where Webpack should look for source files as a named argument `sourceFolders`. 
The passed `sourceFolders` argument overrides the default `sourceFolders`. 
