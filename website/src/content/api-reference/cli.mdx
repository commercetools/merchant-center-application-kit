...
Additionally, after creating a custom application using the `config:sync` command, you should add the [Custom Application ID](/api-reference/application-config#envproductionapplicationid) generated to the application config file.
