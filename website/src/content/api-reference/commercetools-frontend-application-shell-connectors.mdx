...
This is the React context provider that loads the image regex configuration and expose it in the React context so that children can access the configuration.
