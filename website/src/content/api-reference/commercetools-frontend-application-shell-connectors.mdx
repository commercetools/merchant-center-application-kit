...
<MultiCodeExample>
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/use-application-context.jsx" highlightLines={[4,5,6]} />
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/use-application-context.tsx" highlightLines={[4,5,6]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/with-application-context.jsx" highlightLines={[14,15,16]} />
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/with-application-context.tsx" highlightLines={[25,26,27,28,29]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/get-project-extension-image-regex.jsx" />
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/get-project-extension-image-regex.tsx" />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/with-project-extension-image-regex.jsx" />
  <CodeExample path="api-reference/commercetools-frontend-application-shell-connectors/with-project-extension-image-regex.tsx" />
</MultiCodeExample>
