...
You can use different `entryPointUriPath` values per deployment to mimic having multiple environments of the same Custom Application.
We explain this further in the [Help section](/help-needed/#i-want-to-use-a-test-or-staging-environment-for-my-custom-application).
