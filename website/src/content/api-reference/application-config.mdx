...
The `icon` identifies the Custom Application in the Merchant Center menu. You can choose one of the following pre-defined icons by referencing it with the special expansion-like syntax `${path:}`:
