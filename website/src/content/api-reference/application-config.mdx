...
In case more granular permissions need to be applied for local development of a Custom Application, provide `teamId` of the team that the user is part of.

Additionally, please make sure to follow the guidelines from the [help needed documentation](/help-needed#granular-permissions-for-custom-application-local-development) to enable this use case.
