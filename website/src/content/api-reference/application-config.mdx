...
Additionally, please make sure to follow the guidelines from the [help needed](/help-needed#granular-permissions-for-custom-application-local-development) section to enable this use case.
