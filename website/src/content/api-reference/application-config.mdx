...
<MultiCodeExample>
  <CodeExample path="api-reference/application-config/runtime-application-environment.jsx" highlightLines={[3]} />
  <CodeExample path="api-reference/application-config/runtime-application-environment.tsx" highlightLines={[9]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample path="api-reference/application-config/environment-prop.jsx" />
  <CodeExample path="api-reference/application-config/environment-prop.tsx" />
</MultiCodeExample>
