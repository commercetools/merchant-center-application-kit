...
When displaying the content of a page it is important to structure it in a proper way following the heuristic principles of visual hierarchy.

We provide several components that implements these layout guidelines.

## Components for narrow layout

### PageContentNarrow

A page content layout with narrow size. Refer to [Page content layouts](/development/page-content-layouts) for more information about the guidelines.
...
## Components for wide layout

### PageContentWide

A page content layout with wide size. Refer to [Page content layouts](/development/page-content-layouts) for more information about the guidelines.
...
| Props | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `columns` | `enum` <br/>`1`, `1/1`, `2/1` | - | `1` | For single-column layout, use the `1`. For two-columns layout use `1/1` for two columns of the same size and `2/1` for two columns with the left one being wider and the right one being narrower.<br/>When using two-columns layout, the first two children are rendered on the left and right columns respectively. |
| `gapSize` | `enum` <br/>`10`, `20` | - | `20` | The space between the two columns. |
| `children` | `node` | ✅ | - | Content rendered within this layout. |

## Components for full layout

### PageContentFull

A page content layout with full size. Refer to [Page content layouts](/development/page-content-layouts) for more information about the guidelines.
