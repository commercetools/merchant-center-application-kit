...
import { TabularModalPage, useModalState } from '@commercetools-frontend/application-components';
...
A composition of Tab Header components enables navigation within a Tabular Modal page.
...
const TabsView = () => (
  <Router>
    <TabHeader to="/tab-one">
      Tab One
    </TabHeader>
    <TabHeader to="/tab-two">
      Tab Two
    </TabHeader>
  </Router>
);
...
| Props                           | Type                       | Required | Default                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------- | -------------------------- | :------: | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `to`                            | `string` or `object`       |    ✅    | -                        | Path that the `TabHeader` directs to when not disabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `name`                          | `string`                   |          | -                        | Name visible in DOM for the sake of tracking and testing.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `isDisabled`                    | `boolean`                  |          | `false`                  | If `true`, indicates that the element is in a disabled state.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `exact`                         | `boolean`                  |          | `false`                  | If set to `true` `TabHeader` will be visible as active only when there is an exact match of route.                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `onClick`                       | `function`                 |          | -                        | A callback function, called when TabHeader is clicked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                                                             
| `intlMessage`                   | `object`                   |          | -                        | An `intl` message object that will be rendered with `FormattedMessage`. Required if `children` is not provided.                                                                                                                                                                                                                                                                                                                                                                                                            |
| `children`                      | `node`                     |          | -                        | Any React node passed to LinkWrapper. Required if `intlMessage` is not provided.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
