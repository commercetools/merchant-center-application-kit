...
Info Detail pages are controlled components used to render a page equivalent to `InfoModalPage` but not rendered as a modal.
...
| `showPageTopBar`                | `boolean`                       |    -     | `false`                            | Makes page top bar visible.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Form Detail pages are controlled components used to render a page with a form or something that requires user input. Equivalent to `FormModalPage` but not rendered as a modal.
