...
| `zIndex`            | `number`   |    -     | -                 | -  | The `z-index` value to be applied to the overlay container. By default the all modal containers are automatically assigned a correct `z-index` value. If this prop is defined, it will overwrite the assigned value.                                                                                                                                                                                                           |
