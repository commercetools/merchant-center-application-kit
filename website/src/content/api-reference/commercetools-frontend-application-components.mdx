...
The `<InfoDetailPage>` may be used as a direct child of one of the main pages. A back link in the header section is optional.
...
| `onPreviousPathClick`           | `function`                      |    -     | -                                  | If passed, the top bar of the page is rendered and the function is called when the back button is clicked.                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
The `<FormDetailPage>` may be used as a direct child of one of the main pages. A back link in the header section is optional.
The layout of this page can be recognized by the gray background header and the white content background.
...
The `<CustomFormDetailPage>` may be used as a direct child of one of the main pages. A back link in the header section is optional.
The layout of this page can be recognized by the gray background header and the white content background.
