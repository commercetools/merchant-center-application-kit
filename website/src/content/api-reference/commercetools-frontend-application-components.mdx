...
A composition of Tab Header components enable navigation within a Tabular Modal page.
  ...
  return (
    <Router>
      <TabList>
        ...
        <TabHeader name="tab-two" to="/tab-two">
          Tab Two
        </TabHeader>
      </TabList>
    </Router>
...
| Props                           | Type                       | Required | Default                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------- | -------------------------- | :------: | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`                          | `string`                   |    ✅    | -                        | Value of `data-track-component` attribute in DOM.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `to`                            | `string`                   |          | -                        | Path that the TabHeader directs to when not disabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `isDisabled`                    | `boolean`                  |          | -                        | If `true`, indicates that the element is in a disabled state.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `exact`                         | `boolean`                  |          | -                        | If set to true TabHeader will be visible as active only when there is an exact match of route.                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `onClick`                       | `function`                 |          | -                        | A callback function, called when TabHeader is clicked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                                                             |
| `children`                      | `node`                     |    ✅    | -                        | Any React node passed to LinkWrapper.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
