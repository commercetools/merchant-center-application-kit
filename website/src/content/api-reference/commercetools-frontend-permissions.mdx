...
<MultiCodeExample>
  <CodeExample path="api-reference/commercetools-frontend-permissions/use-is-authorized.jsx" />
  <CodeExample path="api-reference/commercetools-frontend-permissions/use-is-authorized.tsx" />
</MultiCodeExample>
