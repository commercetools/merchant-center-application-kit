...
<MultiCodeExample>
  <CodeExample path="migrating-from-project-level-custom-applications/permissions.jsx" highlightLines={[6]} />
  <CodeExample path="migrating-from-project-level-custom-applications/permissions.tsx" highlightLines={[6]} />
</MultiCodeExample>
