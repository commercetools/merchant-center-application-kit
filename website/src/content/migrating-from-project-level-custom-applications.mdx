...
The documentation for Project-level Custom Applications [remains available](https://docs.commercetools.com/custom-applications/legacy) for the [migration period](#migration-period).
