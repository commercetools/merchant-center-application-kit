...
The [new release](/releases/2022-01-31-custom-applications-v21) of Custom Applications is what we call and refer to as **Org-level Custom Applications**.
...
The Project-level Custom Applications will become end-of-life after the [migration period](#migration-period). All related functionalities will be removed by then.
...
Upgrade your Application Kit packages (`@commercetools-frontend/*`) to version `>= 21`. Follow the instructions in the [release note](/releases/2022-01-31-custom-applications-v21).
