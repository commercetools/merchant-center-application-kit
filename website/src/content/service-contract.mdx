...
Customers using custom applications are responsible for the maintainance of the their custom applications. This includes hosting and deployments.
...
All breaking changes are thoroughly documented in the release notes together with migration steps to faciliate the version update.

# Miminal required maintainance
...
To help with the maintainance work, there are tools and services that can be used to get dependency updates. For example Renovate, Dependabot, Greenkeeper, etc.
...
All packages and tools provided by commercetools are open source and licenced under MIT.
