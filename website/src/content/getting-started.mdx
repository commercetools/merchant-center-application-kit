...
To enable local development of a Custom Application by a user being a member of a team with limited permissions go to [Application Config](/api-reference/application-config).
