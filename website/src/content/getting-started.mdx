...
As of version `22.5.0`, an alternative option is available for local development and login. This option is specifically tailored for users belonging to teams with assigned granular permissions. Detailed information about this feature is outlined in the [help needed](/help-needed#granular-permissions-for-custom-application-local-development) section.
