...
Local development and login are also allowed for users being part of an another team with more granular permissions assigned. This feature is available from version `22.5.0` onwards.
