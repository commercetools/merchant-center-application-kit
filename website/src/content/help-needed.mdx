...
We recommend using the [deployment previews](./api-reference/deployment-previews) feature.
...
This approach is no longer recommended. Instead, you can use the [deployment previews](./api-reference/deployment-previews) feature to have a simpler setup.
