...
This implies that changes to the [Custom Application configuration](/../merchant-center/managing-custom-applications), for example the **Application URL**, are effectively applied according to the cache interval.
