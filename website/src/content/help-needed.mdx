...
If the Merchant Center page keeps reloading itself after accessing a Custom Application, most likely there is a misconfiguration of the `entryPointUriPath`.
See [Page reloading behavior](/concepts/merchant-center-proxy-router#page-reloading-behavior) for more information on how to debug and solve this issue.
