...
To emulate a Custom Application preview, you need create multiple Custom Applications in the Merchant Center, each with a different [`entryPointUriPath`](/api-reference/application-config#entrypointuripath).
