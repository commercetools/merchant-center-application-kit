...
<MultiCodeExample title="Channels">
  <CodeExample language="js" path="help-needed/entry-point-uri-path.js" highlightLines={[4,5,6,7]} />
  <CodeExample language="ts" path="help-needed/entry-point-uri-path.ts" highlightLines={[9,10,11,12]} />
</MultiCodeExample>
</Info>
