...
Kindly be aware that this is regarded as a workaround and it is recommended for development teams with prior experience in Custom Application configuration and installation, as it requires a certain configuration overhead.
...
1. Custom Application [configuration](https://docs.commercetools.com/merchant-center/managing-custom-applications#configuring-custom-applications), with a specific emphasis on assigning the [Application ID](https://docs.commercetools.com/merchant-center/managing-custom-applications#installing-a-custom-application).

<Info>

Custom Application URL is not relevant at this point and any acceptable value can be provided in the registration form.
...
3. [Establishing a designated team](https://docs.commercetools.com/merchant-center/teams#create-a-team) (or utilizing an existing one) and obtaining the `teamId` from the Merchant Center URL (`/account/organizations/**organizationId**/teams/**teamId**/members`).
