...
These components are simple wrapper components of the UI Kit field components but they contain and encapsulate all the logic related to the specific field. 

Beforehand, our Channels form must be refactored to use `<Formik>` component as a context provider. As a result, the form component can look like this:
