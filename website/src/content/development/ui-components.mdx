...
The best way to position elements in your Custom Application is to use the `<Spacings>` components.

<Info>

For structuring layouts for page content, please refer to [Page content layouts](/development/page-content-layouts).
