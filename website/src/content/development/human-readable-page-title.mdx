...
When building your Custom Application, it is advisable to consider taking advantage of the readable page title component provided, in order to given more details on the current page location.
...
This provides Custom Applications the ability to display a more useful (Human readable) page title in the browser tab based on the page location. The following format is used:
...
| ------------------------------------ | --------------------------------------- | -------------------------------------------------------------- |
| /some-projecy-key/products/`<id>`             | Products - some-projecy-key - Merchant Center  |             `<product name>` - Products - some-projecy-key - Merchant Center|
