...
Overwriting a title means to explicitly render a different version of the default page title for a specific location. This is done using the [component `<ApplicationPageTitle>`](/api-reference/commercetools-frontend-application-shell#applicationpagetitle).
