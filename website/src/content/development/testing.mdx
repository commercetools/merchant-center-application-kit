...
| `options.renderEntryPointRoutes`       | `Boolean`      | Routing                                                                                                                                                                                            | Pass `true` if you are using the `children` prop for the `<ApplicationShell>`, instead of the `render` prop. This renders then the main application routes according to the given `entryPointUriPath`.                                                                                                                                                                                                                                                                                                          |
