...
| `options.apolloClient` | `ApolloClient`     | Apollo                                                                                                                                                                                             | Pass a custom instance of Apollo client. You can use the exported function `createApolloClient` of `@commercetools-frontend/application-shell`. This is only useful if you also pass the option `disableApolloMocks: true`. .                                                                                                  |
