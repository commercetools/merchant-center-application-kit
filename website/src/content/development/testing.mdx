...
Assuming you have already [set up and installed Cypress](https://docs.cypress.io/guides/getting-started/installing-cypress), we recommend to additionally install the following packages:
