...
<MultiCodeExample title="constants">
  <CodeExample language="js" path="permissions/defining-constants.js" />
  <CodeExample language="ts" path="permissions/defining-constants.ts" />
</MultiCodeExample>
...
<MultiCodeExample title="custom-application-config">
  <CodeExample language="js" path="permissions/menu-links-permissions.js" />
  <CodeExample language="ts" path="permissions/menu-links-permissions.ts" />
</MultiCodeExample>
...
<MultiCodeExample title="routes">
  <CodeExample language="js" path="permissions/routes-permissions.js" highlightLines={[10,11,12]} />
  <CodeExample language="ts" path="permissions/routes-permissions.ts" highlightLines={[10,11,12]} />
</MultiCodeExample>
...
<MultiCodeExample title="component">
  <CodeExample language="js" path="permissions/components-permissions.js" />
  <CodeExample language="ts" path="permissions/components-permissions.ts" />
</MultiCodeExample>
