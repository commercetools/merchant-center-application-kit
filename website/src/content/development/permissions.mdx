...
A Custom Application allows to easily check and evaluate if certain User Permissions are assigned or not, making it possible to determine whether to render something or not, or to disable some UI functionalities or not, and so on.
