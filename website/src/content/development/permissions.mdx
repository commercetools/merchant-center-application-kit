...
<MultiCodeExample title="routes">
  <CodeExample language="jsx" path="development/permissions/routes-permissions.js" highlightLines={[10,11,12]} />
  <CodeExample language="tsx" path="development/permissions/routes-permissions.tsx" highlightLines={[10,11,12]} />
</MultiCodeExample>
...
<MultiCodeExample title="component">
  <CodeExample language="jsx" path="development/permissions/components-permissions.js" />
  <CodeExample language="tsx" path="development/permissions/components-permissions.tsx" />
</MultiCodeExample>
