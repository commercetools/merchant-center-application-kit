...
<MultiCodeExample title="constants">
  <CodeExample path="development/permissions/defining-constants.js" />
  <CodeExample path="development/permissions/defining-constants.ts" />
</MultiCodeExample>
...
<MultiCodeExample title="custom-application-config">
  <CodeExample path="development/permissions/menu-links-permissions.js" />
  <CodeExample path="development/permissions/menu-links-permissions.ts" />
</MultiCodeExample>
...
<MultiCodeExample title="routes">
  <CodeExample path="development/permissions/routes-permissions.jsx" highlightLines={[10,11,12]} />
  <CodeExample path="development/permissions/routes-permissions.tsx" highlightLines={[10,11,12]} />
</MultiCodeExample>
...
<MultiCodeExample title="component">
  <CodeExample path="development/permissions/components-permissions.jsx" />
  <CodeExample path="development/permissions/components-permissions.tsx" />
</MultiCodeExample>
