...
<MultiCodeExample title="messages">
  <CodeExample path="development/translations/messages.jsx" />
  <CodeExample path="development/translations/messages.tsx" />
</MultiCodeExample>
...
<MultiCodeExample title="channels">
  <CodeExample path="development/translations/channels.jsx"  highlightLines={[1,10]} />
  <CodeExample path="development/translations/channels.tsx"  highlightLines={[1,10]} />
</MultiCodeExample>
...
<MultiCodeExample title="channels">
  <CodeExample path="development/translations/intl-message.jsx" highlightLines={[9]} />
  <CodeExample path="development/translations/intl-message.tsx" highlightLines={[9]} />
</MultiCodeExample>
...
<MultiCodeExample>
  <CodeExample path="development/translations/use-intl-hook.jsx" />
  <CodeExample path="development/translations/use-intl-hook.tsx" />
</MultiCodeExample>
...
<MultiCodeExample title="entry-point">
  <CodeExample path="development/translations/dynamically-load-messages.jsx" />
  <CodeExample path="development/translations/dynamically-load-messages.tsx" />
</MultiCodeExample>
