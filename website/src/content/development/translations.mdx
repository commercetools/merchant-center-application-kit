...
Merchant Center applications use [`react-intl`](https://github.com/formatjs/react-intl), a library built on top of the [ECMAScript Internationalization API](https://www.ecma-international.org/ecma-402/1.0/).
