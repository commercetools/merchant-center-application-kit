...
This layout should:
* Be used for normal/complex forms. We recommend using a `horizontalConstraint: 15` for form fields.
* Be used for content where more space is necessary but does not require the full page width. Depending on the type of content, consider also using a `horizontalConstraint: 15` to limit the width.
...
* Not use horizontal constraints and let the content span across the available width.
