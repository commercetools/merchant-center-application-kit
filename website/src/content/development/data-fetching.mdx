...
We would then use our connector Hook in the `Channels` component instead of using the Apollo Client Hooks directly. There is also less code in the React component as most of the logic and configuration is abstracted away in the connector Hook.
