...
See [User Permission Concepts](https://docs.commercetools.com/merchant-center/user-permissions) for more information about the relationships between users, teams, and organizations.
...
The [`@commercetools-frontend/permissions`](https://github.com/commercetools/merchant-center-application-kit/blob/main/packages/permissions/README.md) package should be used to implement and apply the user permissions for the specific parts of the Custom Applications. The package exposes React components and React hooks to make it easy to work with it:
