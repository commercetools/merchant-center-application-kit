...
The Merchant Center allows configuring permissions based on a user’s team. Each teams belong to one organization. While each organization can have as numerous teams and a user can belong to multiple teams across one or different organizations.
