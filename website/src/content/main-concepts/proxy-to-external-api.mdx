...
Developing Custom Applications might require to have your own backend server, for several reasons: storing sensitive credentials for third-party services, performing custom server logic, etc.
