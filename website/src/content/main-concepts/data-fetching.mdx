...
In case you have your own GraphQL API, in addition to the commercetools GraphQL APIs, that is specific to your Custom Application business requirements, you want to be able to connect to it.
...
To do so, you can use any HTTP client of your choice, for example the [`fetch`](https://github.github.io/fetch/) library. See [authenticating requests](/main-concepts/authentication).
