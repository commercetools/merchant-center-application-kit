...
The [project starter example](https://github.com/commercetools/merchant-center-application-kit/tree/master/application-templates/starter) has no explicitly authentication code. Authentication is built into the `<ApplicationShell>` and managed for you.
