...
You can see in the [project starter example](/getting-started/installing-a-starter-application) that there is need to manually handle the access token. Authentication is built into the [`<ApplicationShell>`](/components/application-shell) and managed for you.
