...
The deployment previews are available on a different URL than the production environment. You must host the deployment previews separately from one another and assign a unique but stable URL. You can add as many deployment previews as you like.
