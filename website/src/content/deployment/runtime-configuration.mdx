...
The documentation of this page has been deprecated and it will be removed in the next major release. Instead, read the [documentation about the new application config](/development/application-config) and the [release notes to migrate to the new config](/releases/2020-07-16-introducing-a-new-and-simpler-application-config).
