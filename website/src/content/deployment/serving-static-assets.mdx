...
First, upload the assets from `dist/assets` directory to a CDN or Cloud Storage. Then define the location URL of the storage directory in the `env.production.cdnUrl` in the [application config](/development/application-config).
