...
Because of that, the `now.json` file **cannot be defined statically**. Instead, it needs to be generated programmatically when the Custom Application is built and compiled.
