    ...
    >
      <defs>
        ...
        <rect
          ...
          rx={6}
        />
        <path id="screen-cog_svg__path-3" d="M0 1.163h17.504v17.504H0z" />
      </defs>
      <g
        id="screen-cog_svg__App-KIT-FInal"
        stroke="none"
        strokeWidth={1}
        fill="none"
        fillRule="evenodd"
      >
        <g
          id="screen-cog_svg__App-Kit-/-Landingpage-v2-Copy-4"
          transform="translate(-118 -455)"
        >
          <g
            id="screen-cog_svg__Component-/-View-/-Card"
            transform="translate(56 407)"
          >
            <g id="screen-cog_svg__Background">
              <use
                fill="#000"
                filter="url(#screen-cog_svg__filter-2)"
                xlinkHref="#screen-cog_svg__path-1"
              />
              <use fill="#FFF" xlinkHref="#screen-cog_svg__path-1" />
            </g>
          </g>
          <g id="screen-cog_svg__Group-2" transform="translate(118 455)">
            <g id="screen-cog_svg__Component-/-icon-/-24px-/-built">
              <path
                ...
                id="screen-cog_svg__Fill-1"
                fill="#42788A"
              />
              <path
                id="screen-cog_svg__Fill-4"
                fill="#42788A"
                d="M10.598 27.982h11.234v-1.021H10.598z"
              />
              <path
                id="screen-cog_svg__Fill-6"
                fill="#42788A"
                d="M12.13 27.471h1.02v-3.064h-1.02z"
              />
              <path
                id="screen-cog_svg__Fill-7"
                fill="#42788A"
                d="M19.278 27.471H20.3v-3.064h-1.022z"
              />
              <g id="screen-cog_svg__Group-6" transform="translate(6.97 3.83)">
                <g id="screen-cog_svg__Group-3" transform="translate(0 .17)">
                  <mask id="screen-cog_svg__mask-4" fill="#fff">
                    <use xlinkHref="#screen-cog_svg__path-3" />
                  </mask>
                  <path
                    ...
                    id="screen-cog_svg__Fill-1"
                    fill="#42788A"
                    mask="url(#screen-cog_svg__mask-4)"
                  />
                </g>
                <path
