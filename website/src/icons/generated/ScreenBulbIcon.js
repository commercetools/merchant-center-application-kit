...
function SvgScreenBulbIcon(props) {
  return (
    <svg
      width={32}
      height={32}
    ...
    >
      <defs>
        <filter
          ...
          id="screen-bulb-icon_svg__filter-2"
        >
        ...
        <rect
          id="screen-bulb-icon_svg__path-1"
          x={0}
          y={0}
          width={1168}
          height={278}
      ...
      <g
        id="screen-bulb-icon_svg__App-KIT-FInal"
        stroke="none"
        strokeWidth={1}
        fill="none"
        fillRule="evenodd"
      >
        <g
          id="screen-bulb-icon_svg__App-Kit-/-Landingpage-v2-Copy-4"
          transform="translate(-868 -455)"
        >
          <g
            id="screen-bulb-icon_svg__Component-/-View-/-Card"
            transform="translate(56 407)"
          >
            <g id="screen-bulb-icon_svg__Background">
              <use
                fill="#000"
                filter="url(#screen-bulb-icon_svg__filter-2)"
                xlinkHref="#screen-bulb-icon_svg__path-1"
              />
              <use fill="#FFF" xlinkHref="#screen-bulb-icon_svg__path-1" />
            </g>
          </g>
          <g
            id="screen-bulb-icon_svg__Component-/-icon-/-24px-/-zero_config"
            transform="translate(868 455)"
            fill="#42788A"
          >
            <path
              ...
              id="screen-bulb-icon_svg__Fill-1"
            />
            <path
              id="screen-bulb-icon_svg__Fill-4"
              d="M10.598 27.982h11.234v-1.021H10.598z"
            />
            <path
              id="screen-bulb-icon_svg__Fill-6"
              d="M12.13 27.471h1.02v-3.064h-1.02z"
            />
            <path
              id="screen-bulb-icon_svg__Fill-7"
            ...
            <path
              ...
              id="screen-bulb-icon_svg__Fill-8"
            />
            <path
              id="screen-bulb-icon_svg__Fill-9"
              d="M14.294 18.347h3.666v-1.222h-3.666z"
            />
            <path
              id="screen-bulb-icon_svg__Fill-10"
            ...
            <path
              ...
              id="screen-bulb-icon_svg__Fill-11"
            />
          </g>
        </g>
      </g>
...
export default SvgScreenBulbIcon;
