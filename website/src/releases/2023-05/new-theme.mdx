...
One important feature to mention about the lastest `app-kit` version is that it now includes a new set of components with the goal of helping you laying out the content or your views and reuse the same pattern we use in the Merchant Center native applications.
