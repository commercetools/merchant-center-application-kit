...
For more information, see [Granular permissions for local development](/help-needed#granular-permissions-local-development) within the Custom Applications documentation.
