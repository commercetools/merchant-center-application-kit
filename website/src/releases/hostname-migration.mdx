---
date: 2020-06-10
title: Migrate Custom Applications to the new API hostnames
description: |
  The Merchant Center is adopting a new hostname scheme and deprecating the old hostnames.\
...
# 3. Re-deploy the Custom Application
