...
Recently we [introduced a new host naming scheme](/concepts/merchant-center-api#cloud-regions) for the commercetools APIs, including the Merchant Center, to increase region and cloud provider transparency.
