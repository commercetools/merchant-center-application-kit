...
Merchant Center applications require a runtime configuration to work. This is useful for several reason and for convenience to be able to deploy the application in different environments.
