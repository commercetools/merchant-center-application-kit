...
- [`@testing-library/react`](https://github.com/kentcdodds/react-testing-library) for normal unit tests as well as integration tests (or user flow tests).
- [`cypress`](https://www.cypress.io/) for end-to-end tests.

The `@commercetools-frontend/application-shell` has a [`test-utils`](https://github.com/commercetools/merchant-center-application-kit/blob/master/packages/application-shell/src/test-utils/README.md) export which contains helpers for writing tests using `@testing-library/react`. This is our **recommended approach** for writing tests for your application.
...
- `src/components/main-view/main-view.spec.js`: Tests a component using **@testing-library/react**.
